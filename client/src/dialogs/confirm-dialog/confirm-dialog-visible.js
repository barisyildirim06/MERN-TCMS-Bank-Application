    ...
    return (
        <Dialog visible={visible} width={1000} onClose={handleClose}>
            <div className='accountCardTop' style={{ height: '80vh', width: '100%', margin: '1vh', overflowY: 'scroll' }}>
                ...
                <Checkbox checked={checkboxValues[0]} onChange={() => handleCheckboxValueChange(0)} style={{ display: 'flex', alignItems: 'baseline', fontSize: '20px', margin: '15px 0' }}>
                ...
                <Checkbox checked={checkboxValues[1]} onChange={() => handleCheckboxValueChange(1)} style={{ display: 'flex', alignItems: 'baseline', fontSize: '20px', margin: '15px 0' }}>
                ...
                <Checkbox checked={checkboxValues[2]} onChange={() => handleCheckboxValueChange(2)} style={{ display: 'flex', alignItems: 'baseline', fontSize: '20px', margin: '15px 0' }}>
                ...
                <Checkbox checked={checkboxValues[3]} onChange={() => handleCheckboxValueChange(3)} style={{ display: 'flex', alignItems: 'baseline', fontSize: '20px', margin: '15px 0' }}>
                ...
                <Checkbox checked={checkboxValues[4]} onChange={() => handleCheckboxValueChange(4)} style={{ display: 'flex', alignItems: 'baseline', fontSize: '20px', margin: '15px 0' }}>
                    5. Your principal business is investing in financial products.
                </Checkbox>
                <Checkbox checked={checkboxValues[5]} onChange={() => handleCheckboxValueChange(5)} style={{ display: 'flex', alignItems: 'baseline', fontSize: '20px', margin: '15px 0' }}>
                    6. Your principal business is providing a financial adviser service in relation to financial products.
                </Checkbox>
                <Checkbox checked={checkboxValues[6]} onChange={() => handleCheckboxValueChange(6)} style={{ display: 'flex', alignItems: 'baseline', fontSize: '20px', margin: '15px 0' }}>
                    7. You're in the business of trading in financial products on behalf of other people.
                </Checkbox>
                <Checkbox checked={checkboxValues[7]} onChange={() => handleCheckboxValueChange(7)} style={{ display: 'flex', alignItems: 'baseline', fontSize: '20px', margin: '15px 0' }}>
                ...
                <Checkbox checked={checkboxValues[8]} onChange={() => handleCheckboxValueChange(8)} style={{ display: 'flex', alignItems: 'baseline', fontSize: '20px', margin: '15px 0' }}>
                    9. You are a financial adviser in New Zealand and hold, or operate under, a Financial Advice Provider (FAP) licence.
                </Checkbox>
                <Checkbox checked={checkboxValues[9]} onChange={() => handleCheckboxValueChange(9)} style={{ display: 'flex', alignItems: 'baseline', fontSize: '20px', margin: '15px 0' }}>
